                    ...
                    <div class="card-body">
                        ...
                        <div class="row align-items-center justify-content-around pt-6 pb-5">
                            ...
                            <div class="col-lg-6 col-xl-5">
                                <h2 class="mb-6 fs-8 fw-bolder text-primary"> نـــــســــــيــــــت كــــلـــمـــــة
                                    الــــــســـــــر ؟ </h2>
                                ...
                                <form action="{{ route('reset') }}" method="POST">
                                    ...
                                    <div class="mb-7">
                                        ...
                                        <input type="text" class="form-control py-6" id="exampleInputEmail1"
                                            name="username" aria-describedby="emailHelp">
                                    </div>
                                    <div class="mb-9">
                                        <label for="exampleInputPassword1" class="form-label fw-bold">كلمة السر
                                            الجديدة</label>
                                        <input type="password" class="form-control py-6" name="password"
                                            id="exampleInputPassword1">
                                    </div>
                                    <div class="mb-9">
                                        <label for="exampleInputPassword1" class="form-label fw-bold"> اعادة ادخال كلمة
                                            السر الجديدة</label>
                                        <input type="password" class="form-control py-6" name="password_confirmation"
                                            id="exampleInputPassword1">
                                    </div>
                                    <button type="submit" class="btn btn-primary w-100 mb-7 rounded-pill"> تعيين
                                    </button>
                                </form>
                            </div>
                        </div>
