<aside class="left-sidebar with-vertical">
    ...
    <div class="scroll-sidebar" data-simplebar="init"><div class="simplebar-wrapper" style="margin: -10px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: auto; overflow: hidden;"><div class="simplebar-content" style="padding: 10px;">
      <!-- Sidebar navigation-->
      <nav class="sidebar-nav">
        <ul id="sidebarnav" class="mb-0">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link sidebar-link success-hover-bg" href="../horizontal/index2.html" aria-expanded="false">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link secondary-hover-bg" href="../horizontal/app-notes.html" aria-expanded="false">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link success-hover-bg" href="../horizontal/app-contact.html" aria-expanded="false">
              <span class="aside-icon p-2 bg-success-subtle rounded-1">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link warning-hover-bg" href="../horizontal/app-contact2.html" aria-expanded="false">
              <span class="aside-icon p-2 bg-warning-subtle rounded-1">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link indigo-hover-bg" href="../horizontal/page-pricing.html" aria-expanded="false">
              <span class="aside-icon p-2 bg-indigo-subtle rounded-1">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link primary-hover-bg" href="../horizontal/page-account-settings.html" aria-expanded="false">
              <span class="aside-icon p-2 bg-primary-subtle rounded-1">
                <iconify-icon icon="solar:user-circle-line-duotone" class="fs-6"></iconify-icon>
              </span>
          ...
          <!-- =================== -->
          <li class="sidebar-item">
            <a class="sidebar-link sidebar-link indigo-hover-bg" href="../horizontal/classes.html" aria-expanded="false">
              <span class="aside-icon p-2 bg-indigo-subtle rounded-1">
          ...
          <!-- =================== -->
          <li class="sidebar-item">
            <a class="sidebar-link sidebar-link info-hover-bg" href="../horizontal/attendance.html" aria-expanded="false">
              <span class="aside-icon p-2 bg-info-subtle rounded-1">
          ...
          <!-- =================== -->
          <li class="sidebar-item">
            <a class="sidebar-link sidebar-link warning-hover-bg" href="../horizontal/form-wizard.html" aria-expanded="false">
              <span class="aside-icon p-2 bg-warning-subtle rounded-1">
          ...
          <!-- =================== -->
          <li class="sidebar-item">
            <a class="sidebar-link sidebar-link primary-hover-bg" href="../horizontal/form-repeater.html" aria-expanded="false">
              <span class="aside-icon p-2 bg-primary-subtle rounded-1">
          ...
          <!-- =================== -->
          <li class="sidebar-item">
            <a class="sidebar-link sidebar-link secondary-hover-bg" href="../horizontal/icon-tabler.html" aria-expanded="false">
              <span class="aside-icon p-2 bg-secondary-subtle rounded-1">
          ...
          <!-- =================== -->
          <li class="sidebar-item">
            <a class="sidebar-link sidebar-link primary-hover-bg" href="../horizontal/icon-solar.html" aria-expanded="false">
              <span class="aside-icon p-2 bg-primary-subtle rounded-1">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link sidebar-link success-hover-bg" href="../horizontal/authentication-error.html" aria-expanded="false">
              <span class="aside-icon p-2 bg-success-subtle rounded-1">
                <iconify-icon icon="solar:danger-circle-line-duotone" class="fs-6"></iconify-icon>
              </span>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link sidebar-link primary-hover-bg" href="../horizontal/authentication-maintenance.html" aria-expanded="false">
              <span class="aside-icon p-2 bg-primary-subtle rounded-1">
