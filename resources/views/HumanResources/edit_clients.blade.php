...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form class="mega-vertical"
              action="{{ route('clients.update', $client->client_old->id) }}" method="post"
            ...
            <div class="form-row flex-wrap d-flex gap-3 p-3 border mt-3">
                ...
                <div class="form-group">
                    ...
                    <select class="form-select"
                        ...
                        @foreach ($nationalities as $nationality)
                            <option
                                value="{{ $nationality->id }}"  {{$client->client_old->nationality_id == $nationality->id ? 'selected' : '' }}   >
                                {{ $nationality->name_ar }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phone_work"  value="{{ $client->phone_work }}"
                           class="form-control"/>
                ...
                <div class="form-group">
                    ...
                    <label class="form-label"> الهاتف
                        الارضي</label>
                    <input type="text" name="phone_land"   value="{{ $client->phone_land }}"
                           class="form-control"/>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="block"  value="{{ $client->block }}"
                           class="form-control"/>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="jada"   value="{{ $client->jada }}"
                           class="form-control"/>
                </div>
                <div class="form-group">

                    <label class="form-label"> مبنى</label>
                    <input type="text" name="building"  value="{{ $client->building }}"
                           class="form-control"/>
                </div>
                <div class="form-group">

                    <label class="form-label"> الدور</label>
                    <input type="text" name="floor"    value="{{ $client->floor }}"
                           class="form-control"/>
                </div>
                <div class="form-group">
                    <label class="form-label"> المنزل</label>
                    <input type="text" name="flat"  value="{{ $client->flat }}"
                           class="form-control"/>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-select"
                        ...
                        @foreach ($ministries as $ministry)
                            <option value="{{ $ministry->id }}"  {{$client->client_old->ministry_id == $ministry->id ? 'selected' : '' }}  >
                                {{ $ministry->name_ar }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="salary" value="  {{ $client->salary }}"
                           class="form-control"/>
                </div>
                ...
                <div class="form-group">
                    <label class="form-label"> رقم الحساب
                        البنكي</label>
                    <input type="text"
                           name="bank_account_number" value="{{$client->bank_account_number}}"
                           class="form-control"/>
