...
<div id="bs-example-modal-md" class="modal fade" tabindex="-1" aria-labelledby="bs-example-modal-md" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            ...
            <form id="regionForm" action="{{ route('region.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return validateRegionForm(event)">
                @csrf
                                    ...
                                    <div id="bs-example-modal-edit" class="modal fade" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form id="editregionForm" method="get"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select id="police_station_id " name="police_station_id " class="form-control mb-2">
                                                                    @foreach ($data['Police_station'] as $it)
                                                                        <option value="{{ $it->id }}" {{$it->id == $item->police_station_id ? 'selected' : '' }}>{{ $it->name_ar }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
