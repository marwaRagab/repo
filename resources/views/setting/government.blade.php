                                    ...
                                    <div id="bs-example-modal-edit" class="modal fade" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form id="editgovernmentForm" method="get"
...
<script>
    function validateForm(event) {
        ...
        // Arabic and English name inputs
        ...
        // Check Arabic input for Arabic characters only
        ...
        // Check English input for English characters only
        ...
        if (isValid) {
            document.getElementById('govForm').submit();
        }
    }
</script>
