        ...
        <div id="bs-example-modal-md" class="modal fade" tabindex="-1" aria-labelledby="bs-example-modal-md"
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                    ...
                    <form id="percentForm" action="{{ route('installment__percentages.store') }}" method="POST"
                        enctype="multipart/form-data" onsubmit="return validatePercentForm(event)">
                        @csrf
                            ...
                            <td>
                                <div class="action-btn">
                                    ...
                                    <form id="delete-form-{{ $item->id }}"
                                        action="{{ route('installment__percentages.destroy', $item->id) }}"
        ...
        document.querySelectorAll('.edit').forEach(button => {
            button.addEventListener('click', function() {
                ...
                document.getElementById('editForm').setAttribute('action',
                    `/installment__percentages/update/${id}`);
