                        ...
                        <tr>
                            ...
                            <td>
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <li>
                                            <a class="btn btn-info rounded-0 w-100 mt-2" data-bs-toggle="modal"
                                                data-bs-target="#acceptcondition-modal-md"
                                                data-id="{{ $item->id }}" data-name="{{ $item->name_ar }}"
                                                type="submit">
                                                مقبول بشرط </a>
                                            {{-- <form action="{{ route('myinstall.update', $item->id) }}" method="post"
                                ...
                                <div>
                                    ...
                                    {{-- <div id="archive" class="modal fade" tabindex="-1" aria-labelledby="bs-example-modal-md"
                    ...
                    <div class="modal-dialog modal-dialog-scrollable modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <h5 class="mb-4"> <span class="text-info"> (احمد محمد احمد)</span></h5>
                          <form>
                            <div class="form-row">
                              <div class="form-group">
                                <label> سبب الارشفة</label>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row row" data-index="0">
                            <div class="form-group mb-3 col-6">
                                ...
                                <input type="file" id="issue_pdf" name="issue_pdf" accept=".pdf"
    ...
    <script>
        ...
        if (issueModal) {
            issueModal.addEventListener('show.bs.modal', function(event) {
                ...
                const issueinstallmentId = button?.getAttribute('data-id');
                const issuenameAr = button?.getAttribute('data-name');

                if (issueinstallmentId) {
                    ...
                    if (inputField) inputField.value = issueinstallmentId;

                    const nameSpan = issueModal.querySelector('.text-info');
                    if (nameSpan) nameSpan.textContent = `(${issuenameAr})`;
                }
            });
        }
        // modal accept
