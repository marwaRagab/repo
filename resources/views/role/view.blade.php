<div class="card">
    <div class="d-flex align-items-center justify-content-between px-4 py-3 border-bottom">
        <h4 class="card-title mb-0"> عرض مجموعه عمل</h4>
        <div class="d-flex">
            ...
            <div class="row pt-3">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name_ar" id="name_ar" value="{{ $roles->name_ar }}"
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name_en" id="name_en" value="{{ $roles->name_en }}"
                            class="form-control" disabled />
                    </div>
                </div>
                                ...
                                <li>
                                    <label class="text-indigo my-2">
                                        <input type="checkbox" name="permissions[]" value="{{ $item->id }}"
                                            class="m-2"
                                            {{ in_array($item->id, $assignedPermissions) ? 'checked' : '' }} disabled>
                                        {{ $item->title_ar }}
                                    </label>
                                    <ul class="category-tree">
                                                ...
                                                <li>
                                                    <label class="text-warning my-2">
                                                        <input type="checkbox" name="permissions[]"
                                                            ...
                                                            {{ in_array($childrenRecursive->id, $assignedPermissions) ? 'checked' : '' }}
                                                            disabled>
                                                            ...
                                                            @foreach ($childrenRecursive->childrenRecursive as $subchild)
                                                                <li>
                                                                    <label class="text-muted m-2">
                                                                        <input type="checkbox" name="permissions[]"
                                                                            value="{{ $subchild->id }}" class="m-2"
                                                                            {{ in_array($subchild->id, $assignedPermissions) ? 'checked' : '' }}
                                                                            disabled>
                                                                        {{ $subchild->title_ar }}
                                                                    </label>
                                                                </li>
