                                ...
                                <li>
                                    <label class="text-indigo my-2">
                                        <input type="checkbox" name="permissions[]"
                                            value="{{ $item->id }}" class="m-2" {{ in_array($item->id, $assignedPermissions) ? "checked" : "" }} disabled>
                                        {{ $item->title_ar }}
                                    </label>
                                    <ul class="category-tree">
                                                ...
                                                <li>
                                                    <label class="text-warning my-2">
                                                        <input type="checkbox" name="permissions[]"
                                                            ...
                                                            class="m-2" {{ in_array($childrenRecursive->id, $assignedPermissions) ? "checked" : "" }} disabled>
                                                                ...
                                                                <li>
                                                                    <label class="text-muted m-2">
                                                                        <input type="checkbox"
                                                                            name="permissions[]"
                                                                            value="{{ $subchild->id }}"
                                                                            class="m-2" {{ in_array($subchild->id, $assignedPermissions) ? "checked" : "" }} disabled>
                                                                        {{ $subchild->title_ar }}
                                                                    </label>
                                                                </li>
                                                            @endforeach
