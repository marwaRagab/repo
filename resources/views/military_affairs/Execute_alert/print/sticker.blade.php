                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="9">
                                        ...
                                        المنطقة: {{ $area_name ?? '' }},
                                        القطعه:
                                        {{ $item->installment->client->client_address->last()->block ?? ' ' }},
                                        الشارع:
                                        {{ $item->installment->client->client_address->last()->street ?? ' ' }},
                                        جاده: {{ $item->installment->client->client_address->last()->jada ?? ' ' }},
                                        المبنى
                                        :{{ $item->installment->client->client_address->last()->building ?? '' }},
                                        الدور: {{ $item->installment->client->client_address->last()->floor ?? ' ' }},
                                        الشقة: {{ $item->installment->client->client_address->last()->flat ?? '  ' }},
                                        الرقم الالى :{{ $item->installment->client->house_id ?? '' }}
                                    </td>
