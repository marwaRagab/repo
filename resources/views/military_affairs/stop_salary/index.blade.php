...
<div class="card mt-4 py-3">
  <div class="d-flex flex-wrap ">
    ...
    <a class="btn-filter  bg-success-subtle text-success px-4 fs-4 mx-1 mb-2">
     طلب حجز الراتب  ({{ $stop_salary_request_counter }})
    </a>
    <a class="btn-filter  bg-success-subtle text-success px-4 fs-4 mx-1 mb-2">
      أمر حجز الراتب
      ({{ $stop_salary_doing_counter }}) </a>
    ...
    <a class="btn-filter px-4 bg-primary-subtle text-primaryfs-4 mx-1 mb-2">
     شئون القوة ({{ $stop_salary_doing_counter }})
    </a>
    <a class="btn-filter bg-danger-subtle text-danger px-4 fs-4 mx-1 mb-2">
      المالية  ({{ $stop_salary_money_counter }})
    </a>
    <a class="btn-filter me-1 mb-1  bg-warning-subtle text-warning  px-4 fs-4 mx-1 mb-2 ">
       الاستقطاع  ({{ $stop_salary_part_counter }})
    </a>
  
     <a class="btn-filter bg-danger-subtle text-danger px-4 fs-4 mx-1 mb-2">
       طلب رفع الحجز  ({{ $stop_salary_cancel_request_counter }})
     </a>
     <a class="btn-filter me-1 mb-1  bg-warning-subtle text-warning  px-4 fs-4 mx-1 mb-2 ">
       رفع الحجز  ({{ $stop_salary_cancel_counter }})
     </a>
  </div>
</div>
<div class="card">
...
<div id="open-settle{{ $one->id }}" class="modal fade" tabindex="-1" aria-labelledby="bs-example-modal-md" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header d-flex align-items-center">
        <h4 class="modal-title" id="myModalLabel">
        ...
        <form>
          <div class="form-row flex-wrap d-flex gap-3 p-3 border mt-3">
            ...
            <div class="form-group">
              ...
              <input type="text" name="first_amount_settle" id="first_amount_settle" class="form-control ">
            </div>
