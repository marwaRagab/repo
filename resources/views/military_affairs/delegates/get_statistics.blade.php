                    ...
                    <thead class="thead-dark">
                      ...
                      @foreach ($data['users'] as $item)
                        <tr>
                          ...
                          <td><a href="../legal-affairs/get-statistics-lawaffaires.html" class="text-underline text-success" >{{App\Models\Military_affairs\Military_affairs_amount::where('created_by', $item->id)->count()}}</a></td>
                          <td>50</td>
