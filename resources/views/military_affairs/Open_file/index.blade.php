                            ...
                            @if( Request::has('governorate_id') &&  Request::get('governorate_id') == $item->installment->client->court->id)
                                <tr data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false"
                                    ...
                                    <td>
                                        ...
                                        <div id="open-file-{{$item->id}}" class="modal fade" tabindex="-1"
                      ...
                      <span class="fw-semibold">
                        عنوان السكن :
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-select" name="place">
                                                                        @foreach($courts as $court)
                                                                            <option
                                                                                value="{{$court->id}}" {{ $item->installment->client->governorate_id==$court->id ?   'selected' : ''}} >
                                                                                {{$court->name_ar}}
                                                                            </option>
                                        ...
                                        <div id="return_to_lated-{{$item->id}}" class="modal fade" tabindex="-1"
                                             ...
                                             aria-hidden="true">
                                            <form class="mega-vertical"
                                                  action="{{url('return_to_lated')}}" method="post"
                                                  enctype="multipart/form-data">
                                                @csrf
                                                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                                    <div class="modal-content">
                                    ...
                                    <td>
                                        {{\App\Models\Court::findorfail($item->installment->client->court->government->id)->name_ar}}
                                    </td>
