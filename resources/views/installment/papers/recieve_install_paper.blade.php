                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3 checkbox-label">
                                <input type="checkbox" id="salary_certificate" name="documents[]"
                                    value="salary_certificate">
                                <label for="salary_certificate">شهادة الراتب</label>
                            </div>
                            <div class="col-md-4 mb-3 checkbox-label">
                                <input type="checkbox" id="account_statement" name="documents[]"
                            ...
                            <div class="col-md-4 mb-3 checkbox-label">
                                <input type="checkbox" id="installment_contract" name="documents[]"
                                    value="installment_contract">
                            ...
                            <div class="col-md-4 mb-3 checkbox-label">
                                <input type="checkbox" id="debt_declaration" name="documents[]"
                                    value="debt_declaration">
                                <label for="debt_declaration">إقرار دين</label>
                            </div>
                            <div class="col-md-4 mb-3 checkbox-label">
                                <input type="checkbox" id="guarantor_debt_declaration" name="documents[]"
                                    value="guarantor_debt_declaration">
                                <label for="guarantor_debt_declaration">إقرار دين كفيل</label>
                            </div>
                            <div class="col-md-4 mb-3 checkbox-label">
                                <input type="checkbox" id="judicial_inquiry" name="documents[]"
                                    value="judicial_inquiry">
