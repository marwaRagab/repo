                                        ...
                                        <div class="tab-pane active p-3" id="navpill-inside-1" role="tabpanel">
                                            <table id="notes1"
                                                ...
                                                <tr data-bs-toggle="collapse" data-bs-target="#collapseExample"
                                                    ...
                                                    <td>
                                                        <p>
                                                            تم مراجعة قسم الاعلان للوقوف على سبب تاخر الامج وتيبن تاخير
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingThree">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                <span
                                    class="text-gray mx-1">( قم بالضغط هنا لاظهار تتبع المعاملة)</span>
                            </button>
                        </h2>
                                    ...
                                    @foreach($invoices as $one)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {{ number_format(($total_madionia), 3, '.', ',') }}</td>
                                            <td>-</td>
                                            <td>{{$one->amount}}</td>
                                            <td>{{$one->date}}</td>
                                                ...
                                                @if($month->status=='not_done')
                                                        ...
                                                        <a class="btn btn-info " data-bs-toggle="modal"
                                                           data-bs-target="#pay-one_{{$month->id}}">
                                                            ...
                                                            @if ($month->installment_type == "first_amount")
                                                                المقدم
                                                            @endif </a>
                                                        <div id="pay-one_{{$month->id}}" class="modal fade"
                                                             tabindex="-1"
                                                             aria-labelledby="pay-oneLabel{{$month->id}}"
                                                             aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                                                <div class="modal-content">
                                                                    <div class="modal-header d-flex align-items-center">
                                                    ...
                                                    <td>
                                                        @if ($month->installment_type == "installment")
                                                            ...
                                                            <div id="pay-part_{{$month->id}}" class="modal fade"
                                                                 tabindex="-1"
                                        ...
                                        @foreach($settle_item as $month)
                                            <tr>
                                                        ...
                                                        <a class="btn btn-info " data-bs-toggle="modal"
                                                           data-bs-target="#pay-settle_{{$month->id}}">
                                                            ...
                                                            @if ($month->installment_type == "first_amount")
                                                                المقدم
                                                            @endif </a>
                                                        <div id="pay-settle_{{$month->id}}" class="modal fade"
                                                             tabindex="-1"
                                                             aria-labelledby="pay-oneLabel{{$month->id}}"
                                                             aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                                ...
                                                @else
                                                    @if ($month->payment_type != "part")
                                                        <td>
                                                            <a href="{{ route('installment.print_recive_ins_money',$month->installment_id ,$month->id) }}"
                                                               class="btn btn-info"> طباعة
                                                            </a>
