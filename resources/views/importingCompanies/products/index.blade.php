                                        ...
                                        <div class="mt-4 space-y-4">
                                            <label class="block">
                                                ...
                                                <select id="company_id" name="company_id"
                                                    ...
                                                    @foreach($companies as $company)
                                                        <option
                                                            value="{{$company->id}}"> {{$company->name_ar}} </option>
                                                    @endforeach
                                                </select>
                                                @error('company_id')
                                            ...
                                            <div class="flex justify-around mt-3">
                                                <label class="block mx-1 mt-3">
                                                    <input type="radio" name="number_type" value="barcode"
                                                           {{ $product->number_type == 1 ? 'checked' : '' }}
                                                           onclick="toggleInput('barcode')"/>
                                                    الباركود
                                                </label>
                                                <label class="block mt-3  mx-1">
                                                    <input type="radio" name="number_type" value="serial"
                                                           {{ $product->number_type == 2 ? 'checked' : '' }}
                                ...
                                <a>
                                    <div x-data="{editModal:false}">
                                        ...
                                        <template x-teleport="#x-teleport-target">
                                            <div
                                                class="fixed inset-0 z-[100] flex flex-col items-center justify-center overflow-hidden px-4 py-6 sm:px-5"
                                                x-show="editModal" role="dialog"
                                                @keydown.window.escape="editModal = false">
                                                <div
